...
#     https://colab.research.google.com/drive/1telpLwY3lc57jrBUBnNPmG8vr-pjo-gt
# """
...
car_cascade_src = 'haar_cascades/cars.xml'
bus_cascade_src = 'haar_cascades/Bus_front.xml'
...
def detect_vehicles(video_path):
    ...
    output_path = f"static/uploads/processed_{os.path.basename(video_path)}"
    out = None
